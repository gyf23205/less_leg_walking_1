...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    kae = torch.load("/home/joonwon/github/Koopman_decompose_ext/KAE/waypoints/ForMOE_p1_pad256_obv32.pth", map_location=env.unwrapped.device, weights_only=False)
    # Related parameters
    p = 1
    observable_dim = 32
    act_dim = 12
